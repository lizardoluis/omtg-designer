...
public class SQLGenerator {
	...
	public SQLGenerator(String ddlFilePath, String offLineConstraintsFilePath,
	...
	public SQLGenerator(StringWriter ddlSW, StringWriter offLineConstraintsSW,
	...
	private void createSpatialIndex(OMTGClass omtgClass) {
		...
		ddl.appendCreateSpatialIndex(omtgClass.getName(),
				OMTG2OracleSQLMapper.mapClassType(omtgClass.getType()));
	}
	...
	private void createSpatialAggregationConstraint(OMTGRelationship omtgRel,
		...
		ddl.appendCreateSpatialIndex("Sa_aux",
				OMTG2OracleSQLMapper.mapClassType("polygon"), "p_geom");

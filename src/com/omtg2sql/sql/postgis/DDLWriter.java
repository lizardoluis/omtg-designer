...
//		create_spatial_error_table = true;
	...
	public void appendAlterTableAddColumn(String relationshipName, String mainTableName, String secTableName,
		...
		for (int i = 0; i < keysName.size(); i++) {
			appendColumn("ADD COLUMN", keysName.get(i), OMTG2PostgisMapper.mapAttributeType(keysType.get(i), length.get(i), scale.get(i)), 
	...
	private void appendColumn(String addColumn, String columnName, String columnType, String defaultValue, boolean notNullValue,
...
//					OMTG2PostgisMapper.mapAttributeType(types.get(i), length.get(i), scale.get(i)), prefix,
...
//	}
	...
	public void appendCreateSpatialIndex(String tableName) {
		...
		appendSQL("CREATE INDEX SIDX_" + tableName);
